...
$(document).ready(function () {
    //init 
    let cw = document.documentElement.clientWidth * 1
    if (cw <= 840) {
        $('#sidebar').css("width", "0");
        $('#mycontainer').css("left", "0")
    }
    ...
    if (burger !== null)
        burger.addEventListener(
            ...
            function () {
                ...
                var child;
                child = this.childNodes[0].classList || null;
                if (child) {
